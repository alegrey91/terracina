...
//
// This package should not import any other terracina packages.
package version
...
// Header is the header name used to send the current terracina version
// in http requests.
const Header = "Terracina-Version"
