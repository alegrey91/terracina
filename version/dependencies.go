...
var interestingDependencies = map[string]struct{}{
	...
	"github.com/hashicorp/terracina-svchost": {},
}

// InterestingDependencies returns the compiled-in module version info for
// a small number of dependencies that Terracina uses broadly and which we
// tend to upgrade relatively often as part of improvements to Terracina.
//
