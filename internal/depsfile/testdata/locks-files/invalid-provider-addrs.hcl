...
provider "Registry.terracina.io/example/example" { # ERROR: Non-normalized provider source address
...
# support the Terracina 0.13 upgrade process.
provider "registry.terracina.io/-/null" { # ERROR: Invalid provider source address
}

# Built-in providers are not allowed, because they are not versioned
# independently of the Terracina CLI release they are embedded in.
provider "terracina.io/builtin/foo" { # ERROR: Invalid provider source address
}
