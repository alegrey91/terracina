...
// Resource represents a thing in Terracina that has a set of configurable
...
//
// In spite of the name, this struct is not used only for terracina resources,
...
type Resource struct {
	...
	// called specifically by Terracina when the stored schema version is less
	// than the current SchemaVersion of the Resource.
	//
	...
	// Terracina has created for this resource - it can be used to customize the
	...
	//
	// The phases Terracina runs this in, and the state available via functions
...
// terracina.InstanceState.
func (r *Resource) ShimInstanceStateFromValue(state cty.Value) (*terracina.InstanceState, error) {
	// Get the raw shimmed value. While this is correct, the set hashes don't
	// match those from the Schema.
	s := terracina.NewInstanceStateShimmedFromValue(state, r.SchemaVersion)
...
type StateMigrateFunc func(
	int, *terracina.InstanceState, interface{}) (*terracina.InstanceState, error)
...
func (r *Resource) Apply(
	...
	meta interface{}) (*terracina.InstanceState, error) {
	...
	if s == nil {
		// The Terracina API dictates that this should never happen, but
		// it doesn't hurt to be safe in this case.
		s = new(terracina.InstanceState)
	}
...
func (r *Resource) Diff(
	s *terracina.InstanceState,
	c *terracina.ResourceConfig,
	meta interface{}) (*terracina.InstanceDiff, error) {
...
func (r *Resource) simpleDiff(
	...
	if instanceDiff == nil {
		instanceDiff = terracina.NewInstanceDiff()
	}
...
func (r *Resource) Validate(c *terracina.ResourceConfig) ([]string, []error) {
...
func (r *Resource) upgradeState(s *terracina.InstanceState, meta interface{}) (*terracina.InstanceState, error) {
	var err error
...
func isReservedResourceFieldName(name string, s *Schema) bool {
	...
	// See https://github.com/terracina-providers/terracina-provider-aws/pull/1626#issuecomment-328881415
...
func (r *Resource) Data(s *terracina.InstanceState) *ResourceData {
...
func (r *Resource) checkSchemaVersion(is *terracina.InstanceState) (bool, int) {
...
func (r *Resource) recordCurrentSchemaVersion(
	state *terracina.InstanceState) *terracina.InstanceState {
