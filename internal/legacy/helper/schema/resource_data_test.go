...
func TestResourceDataGet(t *testing.T) {
	cases := []struct {
		...
		// #14 List of maps
		{
			...
			Diff: &terracina.InstanceDiff{
				Attributes: map[string]*terracina.ResourceAttrDiff{
					...
					"config_vars.1.bar": &terracina.ResourceAttrDiff{
						Old: "",
						New: "baz",
					},
				},
		...
		// #18
		{
			...
			Diff: &terracina.InstanceDiff{
				Attributes: map[string]*terracina.ResourceAttrDiff{
					"data.10.value": &terracina.ResourceAttrDiff{
						Old: "50",
						New: "80",
					},
				},
		...
		// #22 Float diff
		{
			...
			Diff: &terracina.InstanceDiff{
				Attributes: map[string]*terracina.ResourceAttrDiff{
					"ratio": &terracina.ResourceAttrDiff{
						Old: "-0.5",
						New: "33.0",
					},
				},
		...
		// #23 Sets with removed elements
		{
			...
			Diff: &terracina.InstanceDiff{
				Attributes: map[string]*terracina.ResourceAttrDiff{
					...
					"ports.80": &terracina.ResourceAttrDiff{
						Old: "80",
						New: "80",
					},
					"ports.8080": &terracina.ResourceAttrDiff{
						Old:        "8080",
						New:        "0",
						NewRemoved: true,
					},
...
func TestResourceDataGetOk(t *testing.T) {
	cases := []struct {
		...
		// indistinguishable from unset config.
		{
			...
			Diff: &terracina.InstanceDiff{
				Attributes: map[string]*terracina.ResourceAttrDiff{
					"from_port": &terracina.ResourceAttrDiff{
						Old: "",
						New: "0",
					},
				},
...
func TestResourceDataHasChange(t *testing.T) {
	cases := []struct {
		...
		// https://github.com/hashicorp/terracina/issues/927
		{
			Schema: map[string]*Schema{
				"ports": &Schema{
					Type:     TypeSet,
			...
			Diff: &terracina.InstanceDiff{
				Attributes: map[string]*terracina.ResourceAttrDiff{
					"tags.foo": &terracina.ResourceAttrDiff{
						Old: "",
						New: "bar",
					},
				},
...
func TestResourceDataState_dynamicAttributes(t *testing.T) {
	cases := []struct {
		...
		Result    *terracina.InstanceState
	}{
		{
			Schema: map[string]*Schema{
...
func TestResourceDataState_schema(t *testing.T) {
	cases := []struct {
		...
		// #5 List of resources
		{
			...
			Diff: &terracina.InstanceDiff{
				Attributes: map[string]*terracina.ResourceAttrDiff{
					...
					"ingress.1.from": &terracina.ResourceAttrDiff{
						Old: "",
						New: "100",
					},
				},
		...
		// #17 Sets
		{
			...
			Diff: &terracina.InstanceDiff{
				Attributes: map[string]*terracina.ResourceAttrDiff{
					"ports.120": &terracina.ResourceAttrDiff{
						New: "120",
					},
				},
			},
		...
		// #23 Set of maps
		{
			...
			Diff: &terracina.InstanceDiff{
				Attributes: map[string]*terracina.ResourceAttrDiff{
					"ports.10.uuids.#": &terracina.ResourceAttrDiff{
						NewComputed: true,
					},
				},
			},
...
func TestResourceData_nonStringValuesInMap(t *testing.T) {
	cases := []struct {
	...
	}{
		{
			...
			Diff: &terracina.InstanceDiff{
				Attributes: map[string]*terracina.ResourceAttrDiff{
					"boolMap.%": &terracina.ResourceAttrDiff{
						Old: "",
						New: "1",
					},
					"boolMap.boolField": &terracina.ResourceAttrDiff{
						Old: "",
						New: "true",
					},
				},
		...
		},
		{
			...
			Diff: &terracina.InstanceDiff{
				Attributes: map[string]*terracina.ResourceAttrDiff{
					"intMap.%": &terracina.ResourceAttrDiff{
						Old: "",
						New: "1",
					},
					"intMap.intField": &terracina.ResourceAttrDiff{
						Old: "",
						New: "8",
					},
				},
		...
		},
		{
			...
			Diff: &terracina.InstanceDiff{
				Attributes: map[string]*terracina.ResourceAttrDiff{
					"floatMap.%": &terracina.ResourceAttrDiff{
						Old: "",
						New: "1",
					},
					"floatMap.floatField": &terracina.ResourceAttrDiff{
						Old: "",
						New: "8.22",
					},
				},
...
func TestResourceDataSetId_clear(t *testing.T) {
	d := &ResourceData{
		state: &terracina.InstanceState{ID: "bar"},
	}
	d.SetId("")
