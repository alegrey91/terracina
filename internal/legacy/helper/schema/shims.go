...
// derives a terracina.InstanceDiff to give to the legacy providers. This is
...
func DiffFromValues(prior, planned cty.Value, res *Resource) (*terracina.InstanceDiff, error) {
...
func diffFromValues(prior, planned cty.Value, res *Resource, cust CustomizeDiffFunc) (*terracina.InstanceDiff, error) {
	...
	cfg := terracina.NewResourceConfigShimmed(planned, configSchema)
...
// ApplyDiff takes a cty.Value state and applies a terracina.InstanceDiff to
...
func ApplyDiff(base cty.Value, d *terracina.InstanceDiff, schema *configschema.Block) (cty.Value, error) {
...
// StateValueFromInstanceState converts a terracina.InstanceState to a
// cty.Value as described by the provided cty.Type, and maintains the resource
// ID as the "id" attribute.
func StateValueFromInstanceState(is *terracina.InstanceState, ty cty.Type) (cty.Value, error) {
