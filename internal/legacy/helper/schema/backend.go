...
// an object type) into a minimal old-style *terracina.ResourceConfig object
...
func (b *Backend) shimConfig(obj cty.Value) *terracina.ResourceConfig {
	...
	return &terracina.ResourceConfig{
		Config: shimMap,
		Raw:    shimMap,
	}
}
