...
// ResourceImporter defines how a resource is imported in Terracina. This
...
//
// "Importing" in Terracina is the process of taking an already-created
// resource and bringing it under Terracina management. This can include
// updating Terracina state, generating Terracina configuration, etc.
type ResourceImporter struct {
	...
	// insert into the Terracina state. If this isn't specified, then
	// the ID is passed straight through.
	State StateFunc
}

// StateFunc is the function called to import a resource into the
// Terracina state. It is given a ResourceData with only ID set. This
