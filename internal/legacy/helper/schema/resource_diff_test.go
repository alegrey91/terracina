...
type resourceDiffTestCase struct {
	...
	Config        *terracina.ResourceConfig
...
func testDiffCases(t *testing.T, oldPrefix string, oldOffset int, computed bool) []resourceDiffTestCase {
	return []resourceDiffTestCase{
		...
		resourceDiffTestCase{
			...
			Diff: &terracina.InstanceDiff{
				Attributes: map[string]*terracina.ResourceAttrDiff{
					"foo.1996459178": &terracina.ResourceAttrDiff{
						Old:        "bar",
						New:        "",
						NewRemoved: true,
					},
					"foo.2015626392": &terracina.ResourceAttrDiff{
						Old: "",
						New: "baz",
					},
				},
			...
			Expected: &terracina.InstanceDiff{
				Attributes: func() map[string]*terracina.ResourceAttrDiff {
					result := map[string]*terracina.ResourceAttrDiff{}
					if computed {
						result["foo.#"] = &terracina.ResourceAttrDiff{
							Old:         "1",
							New:         "",
							NewComputed: true,
						}
					} else {
						result["foo.2800005064"] = &terracina.ResourceAttrDiff{
							Old: "",
							New: "qux",
						}
						result["foo.1996459178"] = &terracina.ResourceAttrDiff{
							Old:        "bar",
							New:        "",
							NewRemoved: true,
						}
		...
		resourceDiffTestCase{
			...
			Diff: &terracina.InstanceDiff{
				Attributes: map[string]*terracina.ResourceAttrDiff{
					"foo.0": &terracina.ResourceAttrDiff{
						Old: "bar",
						New: "baz",
					},
				},
			...
			Expected: &terracina.InstanceDiff{
				Attributes: func() map[string]*terracina.ResourceAttrDiff {
					result := make(map[string]*terracina.ResourceAttrDiff)
					if computed {
						result["foo.#"] = &terracina.ResourceAttrDiff{
							Old:         "1",
							New:         "",
						...
						result["foo.0"] = &terracina.ResourceAttrDiff{
							Old: "bar",
							New: "qux",
						}
					}
		...
		resourceDiffTestCase{
			...
			Diff: &terracina.InstanceDiff{
				Attributes: map[string]*terracina.ResourceAttrDiff{
					"foo.bar": &terracina.ResourceAttrDiff{
						Old: "baz",
						New: "qux",
					},
				},
			...
			Expected: &terracina.InstanceDiff{
				Attributes: func() map[string]*terracina.ResourceAttrDiff {
					...
					if computed {
						...
						result["foo.bar"] = &terracina.ResourceAttrDiff{
							Old:        "baz",
							New:        "",
							NewRemoved: true,
						}
		...
		resourceDiffTestCase{
			...
			Diff: &terracina.InstanceDiff{
				Attributes: map[string]*terracina.ResourceAttrDiff{
					"top.4.foo": &terracina.ResourceAttrDiff{
						Old: "",
						New: "1",
					},
					"top.4.bar": &terracina.ResourceAttrDiff{
						Old: "",
						New: "3",
					},
					"top.24.foo": &terracina.ResourceAttrDiff{
						Old: "",
						New: "12",
					},
					"top.24.bar": &terracina.ResourceAttrDiff{
						Old: "",
						New: "12",
					},
				},
			...
			Expected: &terracina.InstanceDiff{
				Attributes: func() map[string]*terracina.ResourceAttrDiff {
					result := make(map[string]*terracina.ResourceAttrDiff)
					if computed {
						result["top.#"] = &terracina.ResourceAttrDiff{
							Old:         "2",
							New:         "",
							NewComputed: true,
						}
						...
						result["top.5.foo"] = &terracina.ResourceAttrDiff{
							Old: "",
							New: "1",
						}
						result["top.5.bar"] = &terracina.ResourceAttrDiff{
							Old: "",
							New: "4",
						}
						result["top.25.foo"] = &terracina.ResourceAttrDiff{
							Old: "",
							New: "13",
						}
						result["top.25.bar"] = &terracina.ResourceAttrDiff{
							Old: "",
							New: "12",
						}
						result["top.43.foo"] = &terracina.ResourceAttrDiff{
							Old: "",
							New: "21",
						}
						result["top.43.bar"] = &terracina.ResourceAttrDiff{
							Old: "",
							New: "22",
						}
					}
		...
		resourceDiffTestCase{
			...
			Config:   testConfig(t, map[string]interface{}{}),
			Diff:     &terracina.InstanceDiff{Attributes: map[string]*terracina.ResourceAttrDiff{}},
			Key:      "foo",
			NewValue: "baz",
			Expected: &terracina.InstanceDiff{
				Attributes: map[string]*terracina.ResourceAttrDiff{
		...
		resourceDiffTestCase{
			...
			Expected: &terracina.InstanceDiff{
				Attributes: func() map[string]*terracina.ResourceAttrDiff {
					if computed {
						return map[string]*terracina.ResourceAttrDiff{
							"foo": &terracina.ResourceAttrDiff{
								NewComputed: computed,
							},
						}
...
func TestForceNew(t *testing.T) {
	cases := []resourceDiffTestCase{
		...
		resourceDiffTestCase{
			...
			Diff: &terracina.InstanceDiff{
				Attributes: map[string]*terracina.ResourceAttrDiff{
					"foo.0.bar": &terracina.ResourceAttrDiff{
						Old: "abc",
						New: "abcdefg",
					},
					"foo.0.baz": &terracina.ResourceAttrDiff{
						Old: "xyz",
						New: "changed",
					},
				},
...
func TestClear(t *testing.T) {
	cases := []resourceDiffTestCase{
		resourceDiffTestCase{
			...
			Key:      "foo",
			Expected: &terracina.InstanceDiff{Attributes: map[string]*terracina.ResourceAttrDiff{}},
		},
		resourceDiffTestCase{
			Name: "non-computed key, should error",
			Schema: map[string]*Schema{
...
func TestGetChangedKeysPrefix(t *testing.T) {
	cases := []resourceDiffTestCase{
		...
		resourceDiffTestCase{
			...
			Diff: &terracina.InstanceDiff{
				Attributes: map[string]*terracina.ResourceAttrDiff{
					"testfield": &terracina.ResourceAttrDiff{
						Old: "blablah",
						New: "modified",
					},
					"foo.0.bar": &terracina.ResourceAttrDiff{
