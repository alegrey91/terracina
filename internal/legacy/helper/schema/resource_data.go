...
type ResourceData struct {
	...
	newState    *terracina.InstanceState
	partial     bool
...
// calls.
func (d *ResourceData) State() *terracina.InstanceState {
	var result terracina.InstanceState
	result.ID = d.Id()
	result.Meta = d.meta
...
func (d *ResourceData) init() {
	...
	var copyState terracina.InstanceState
	if d.state != nil {
