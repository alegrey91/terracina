...
`,
  ...
  module.moda.provider["registry.terracina.io/hashicorp/test"]
module.moda.provider["registry.terracina.io/hashicorp/test"]
module.moda.test_object.a
  module.moda.provider["registry.terracina.io/hashicorp/test"]
module.moda.test_object.x
  provider["registry.terracina.io/hashicorp/test"].z
provider["registry.terracina.io/hashicorp/test"].z`
...
`})
	...
	expected := `provider["registry.terracina.io/hashicorp/test"]`
...
provider["registry.terracina.io/hashicorp/aws"] (close)
  ...
  provider["registry.terracina.io/hashicorp/aws"]
provider["registry.terracina.io/hashicorp/foo"]
provider["registry.terracina.io/hashicorp/foo"] (close)
  foo_instance.web
  provider["registry.terracina.io/hashicorp/foo"]
`
...
module.sub.module.subsub.foo_instance.one
  module.sub.provider["registry.terracina.io/hashicorp/foo"]
module.sub.provider["registry.terracina.io/hashicorp/foo"]
provider["registry.terracina.io/hashicorp/bar"]
`
