...
// Package configs contains types that represent Terracina configurations and
// the different elements thereof.
//
// The functionality in this package can be used for some static analyses of
// Terracina configurations, but this package generally exposes representations
...
// diagnostics can be converted into Terracina-flavored diagnostics, if needed,
