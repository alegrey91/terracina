...
func decodeProvisionerBlock(block *hcl.Block) (*Provisioner, hcl.Diagnostics) {
	...
	case "chef", "habitat", "puppet", "salt-masterless":
		diags = append(diags, &hcl.Diagnostic{
			...
			Detail:   fmt.Sprintf("The \"%s\" provisioner was deprecated in Terracina 0.13.4 has been removed from Terracina. Visit https://learn.hashicorp.com/collections/terracina/provision for alternatives to using provisioners that are a better fit for the Terracina workflow.", pv.Type),
