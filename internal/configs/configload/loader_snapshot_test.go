...
func TestLoadConfigWithSnapshot(t *testing.T) {
...

	{
		...
		wantModuleDirs := map[string]string{
			...
			"child_a":         "testdata/already-installed/.terracina/modules/child_a",
			"child_a.child_c": "testdata/already-installed/.terracina/modules/child_a/child_c",
			"child_b":         "testdata/already-installed/.terracina/modules/child_b",
			"child_b.child_d": "testdata/already-installed/.terracina/modules/child_b.child_d",
		}
...
func TestSnapshotRoundtrip(t *testing.T) {
	...
	if got, want := childA.Module.SourceDir, "testdata/already-installed/.terracina/modules/child_a"; got != want {
