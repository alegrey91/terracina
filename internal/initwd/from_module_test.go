...
func TestDirFromModule_registry(t *testing.T) {
	...
	modsDir := filepath.Join(dir, ".terracina/modules")
	...
	wantCalls := []testInstallHookCall{
		...
		},
		{
			...
			LocalPath: filepath.Join(dir, ".terracina/modules/root"),
		},
		{
			Name:       "Install",
			ModuleAddr: "root.child_a",
			LocalPath:  filepath.Join(dir, ".terracina/modules/root/modules/child_a"),
		},
		{
			Name:       "Install",
			ModuleAddr: "root.child_a.child_b",
			LocalPath:  filepath.Join(dir, ".terracina/modules/root/modules/child_b"),
		},
	}
...
func TestDirFromModule_submodules(t *testing.T) {
	...
	//
	// See also: https://github.com/hashicorp/terracina/issues/26014
	//
	...
	modInstallDir := filepath.Join(dir, ".terracina/modules")
...
// https://github.com/hashicorp/terracina/issues/23010
func TestDirFromModule_rel_submodules(t *testing.T) {
	...
	modInstallDir := ".terracina/modules"
