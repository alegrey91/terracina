...
Terracina has its own fork of these functions because Go 1.17 included a
...
After careful consideration, the Terracina team has concluded that Terracina's
...
library, and so we can't justify a similar exception to our Terracina 1.0
