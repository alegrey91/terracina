...
// a particular Terracina configuration and their current statuses.
//
...
// how many checkable objects will be dynamically-declared yet. Terracina Core
...
type configCheckableState struct {
	...
	// once Terracina Core reports the expansion of this configuration
	// construct.
	//
	// The leaf Status values will initially be StatusUnknown
	// and then gradually updated by Terracina Core as it visits the
...
//
// The given address must refer to a checkable object that Terracina Core
