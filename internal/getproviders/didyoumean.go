...
// namespace in the Terracina registry. It will always return no result for
...
// includes a wildcard for registry.terracina.io.
//
...
func findLegacyProviderLookupSource(host svchost.Hostname, source Source) *RegistrySource {
	...
	case MultiSource:
		...
		// except the hostname, like "registry.terracina.io/*/*"
