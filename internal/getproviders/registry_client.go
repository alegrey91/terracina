...
const (
	terracinaVersionHeader = "X-Terracina-Version"
...
//     supported by this version of terracina.
...
func (c *registryClient) PackageMeta(ctx context.Context, provider addrs.Provider, version Version, target Platform) (PackageMeta, error) {
	...
	// Verify that this version of terracina supports the providers' protocol
	// version(s)
...
func (c *registryClient) addHeadersToRequest(req *http.Request) {
	...
	req.Header.Set(terracinaVersionHeader, version.String())
}
