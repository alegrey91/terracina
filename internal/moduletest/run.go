...
//
// Point 2 is a bit complicated so worth expanding on. In normal Terracina
...
// identified to the user but not to fail the actual Terracina operation. During
...
// diagnostics were generated by custom conditions. Terracina adds the
