...
type moduleStateV1 struct {
	...
	//
	// Terracina uses this information to build valid destruction
	// orders and to warn the user if they're destroying a module that
	// another resource depends on.
	//
	// Things can be put into this list that may not be managed by
	// Terracina. If Terracina doesn't find a matching ID in the
...
type resourceStateV1 struct {
	// This is filled in and managed by Terracina, and is the resource
	...
	// similar to Tainted instances in that Terracina is only tracking them in
