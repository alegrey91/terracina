...
func init() {
	...
	registerConcludedExperiment(ModuleVariableOptionalAttrs, "The final feature corresponding to this experiment differs from the experimental form and is available in the Terracina language from Terracina v1.3.0 onwards.")
}
...
// version of Terracina but are no longer available, either because the feature
