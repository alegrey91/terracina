...
// root module of the configuration, alongside the .terracina directory
...
// to match where the ".terracina" directory would also be written in that
...
const dependencyLockFilename = ".terracina.lock.hcl"
