...
func TestVersion(t *testing.T) {
	...
	// as a good smoke test for whether the Terracina binary can even be
	...
	wantVersion := fmt.Sprintf("Terracina v%s", version.String())
...
func TestVersionWithProvider(t *testing.T) {
	...
	// selected version of the "template" provider.
	{
		...
		wantMsg := "+ provider registry.terracina.io/hashicorp/template v" // we don't know which version we'll get here
