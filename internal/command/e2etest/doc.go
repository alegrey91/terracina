...
// Package e2etest contains a set of tests that run against a real Terracina
// binary, compiled on the fly at the start of the test run.
//
// These tests help ensure that key end-to-end Terracina use-cases are working
...
//
//	go test -v github.com/hashicorp/terracina/internal/command/e2etest
//
// This will compile on the fly a Terracina binary and run the tests against
// it.
//
