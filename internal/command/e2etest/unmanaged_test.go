...
import (
	...
	tfplugin5 "github.com/hashicorp/terracina/internal/plugin"
	tfplugin "github.com/hashicorp/terracina/internal/plugin6"
	simple5 "github.com/hashicorp/terracina/internal/provider-simple"
	simple "github.com/hashicorp/terracina/internal/provider-simple-v6"
	proto5 "github.com/hashicorp/terracina/internal/tfplugin5"
...
func TestUnmanagedSeparatePlan(t *testing.T) {
	...
	if tf.FileExists(filepath.Join(".terracina", "plugins", "registry.terracina.io", "hashicorp", "test")) {
		t.Errorf("test provider binary found in .terracina dir")
	}
