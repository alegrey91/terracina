...
#
# This will produce a zip file build/terracina-e2etest_windows_amd64.zip which
...
# the Terracina executable. Instead, the caller of the tests must retrieve
...
OUTFILE="terracina-e2etest_${GOOS}_${GOARCH}.zip"

LDFLAGS="-X github.com/hashicorp/terracina/internal/command/e2etest.terracinaBin=./terracina$GOEXE"
...
go test -o "$OUTDIR/e2etest$GOEXE" -c -ldflags "$LDFLAGS" github.com/hashicorp/terracina/internal/command/e2etest
