...
func TestProviderDevOverrides(t *testing.T) {
	...
	tf := e2e.NewBinary(t, terracinaBin, "testdata/provider-dev-override")
	...
	providerExePrefix := filepath.Join(providerExeDir, "terracina-provider-test_")
	providerExe := e2e.GoBuild("github.com/hashicorp/terracina/internal/provider-simple/main", providerExePrefix)
	...
	// NOTE: We're intentionally not running "terracina init" here, because
	...
	// with any registries, mirrors, lock files, etc. To verify "terracina
