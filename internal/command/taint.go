...
func (c *TaintCommand) Help() string {
	helpText := `
Usage: terracina [global options] taint [options] <address>
  ...
  address will reach Terracina correctly, without any special
  interpretation.
