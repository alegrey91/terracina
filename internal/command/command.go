...
const DefaultDataDir = ".terracina"
...
// user-added plugin binaries. Terracina only reads from this path if it
// exists, it is never created by terracina.
const DefaultPluginVendorDir = "terracina.d/plugins/" + pluginMachineName

// DefaultStateFilename is the default filename used for the state file.
const DefaultStateFilename = "terracina.tfstate"

// DefaultStatePersistInterval is the default interval a backend should persist
// Terracina state, if applicable. Backends can set their own custom defaults.
const DefaultStatePersistInterval = 20

// DefaultVarsFilename is the default filename used for vars
const DefaultVarsFilename = "terracina.tfvars"
...
The "backend" in Terracina defines how Terracina operates. The default
