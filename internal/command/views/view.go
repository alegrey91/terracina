...
type View struct {
	...
	// When this is true it's a hint that Terracina is being run indirectly
...
// suggest specific Terracina commands to run, to make more conceptual gestures
// instead for situations where the user isn't running Terracina directly.
//
