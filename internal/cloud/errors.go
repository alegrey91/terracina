...
const ignoreRemoteVersionHelp = "If you're sure you want to upgrade the state, you can force Terracina to continue using the -ignore-remote-version flag. This may result in an unusable workspace."
...
func incompatibleWorkspaceTerracinaVersion(message string, ignoreVersionConflict bool) tfdiags.Diagnostic {
	...
	return tfdiags.Sourceless(severity, "Incompatible Terracina version", description)
}
