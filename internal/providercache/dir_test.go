			...
			legacyProvider: {
				{
					...
					PackageDir: "testdata/cachedir/registry.terracina.io/-/legacy/1.0.0/linux_amd64",
				},
			},
			nullProvider: {
				{
			...
			randomProvider: {
				{
					...
					PackageDir: "testdata/cachedir/registry.terracina.io/hashicorp/random/1.2.0/linux_amd64",
				},
			},
			randomBetaProvider: {
				{
					...
					Version:    versions.MustParseVersion("1.2.0"),
					PackageDir: "testdata/cachedir/registry.terracina.io/hashicorp/random-beta/1.2.0/linux_amd64",
				},
			},
