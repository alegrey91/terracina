...
func TestCachedProviderHash(t *testing.T) {
	cp := &CachedProvider{
		...
		PackageDir: "testdata/cachedir/registry.terracina.io/hashicorp/null/2.0.0/darwin_amd64",
	}
	...
	cp2 := &CachedProvider{
		...
		PackageDir: "testdata/cachedir/registry.terracina.io/hashicorp/null/2.0.0/windows_amd64",
	}
	...
	testCases := map[string]struct {
		...
		"linux": {
			cp: &CachedProvider{
				...
				Version:    getproviders.MustParseVersion("2.0.0"),
				PackageDir: "testdata/cachedir/registry.terracina.io/hashicorp/null/2.0.0/linux_amd64",
			},
			file: "testdata/cachedir/registry.terracina.io/hashicorp/null/2.0.0/linux_amd64/terracina-provider-null",
		},
		"windows": {
			cp: &CachedProvider{
				Provider:   addrs.NewProvider(addrs.DefaultProviderRegistryHost, "hashicorp", "null"),
			...
			file: "testdata/cachedir/registry.terracina.io/hashicorp/null/2.0.0/windows_amd64/terracina-provider-null.exe",
		},
		"missing-executable": {
			cp: &CachedProvider{
				Provider:   addrs.NewProvider(addrs.DefaultProviderRegistryHost, "missing", "executable"),
				Version:    getproviders.MustParseVersion("2.0.0"),
				PackageDir: "testdata/cachedir/registry.terracina.io/missing/executable/2.0.0/linux_amd64",
			},
			err: "could not find executable file starting with terracina-provider-executable",
		},
		"missing-dir": {
			cp: &CachedProvider{
				Provider:   addrs.NewProvider(addrs.DefaultProviderRegistryHost, "missing", "packagedir"),
				Version:    getproviders.MustParseVersion("2.0.0"),
				PackageDir: "testdata/cachedir/registry.terracina.io/missing/packagedir/2.0.0/linux_amd64",
			},
			err: "could not read package directory: open testdata/cachedir/registry.terracina.io/missing/packagedir/2.0.0/linux_amd64: no such file or directory",
		},
	}
