...
// plugin.
//
// This is a bit messy and heuristic-y because historically Terracina used the
...
func (cp *CachedProvider) ExecutableFile() (string, error) {
	...
	// "terracina-provider-happycloud", followed by zero or more additional
	...
	// - terracina-provider-happycloud_v1.0.0
	// - terracina-provider-happycloud.exe
	//
	...
	// compatibility with Terracina 0.12.
	//
	...
	wantPrefix := "terracina-provider-" + cp.Provider.Type
