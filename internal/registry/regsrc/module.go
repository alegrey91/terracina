...
var (
	...
	// already special case module sources in terracina.
...
// Module describes a Terracina Registry Module source.
type Module struct {
...
// ParseModuleSource attempts to parse source as a Terracina registry module
