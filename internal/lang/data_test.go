...
func (d *dataForTests) GetTerracinaAttr(addr addrs.TerracinaAttr, rng tfdiags.SourceRange) (cty.Value, tfdiags.Diagnostics) {
	return d.TerracinaAttrs[addr.Name], nil
}
