...
// implementations outside of the Terracina codebases are not advised.
//
...
type Data interface {
	...
	GetTerracinaAttr(addrs.TerracinaAttr, tfdiags.SourceRange) (cty.Value, tfdiags.Diagnostics)
