...
Since the JSON format cannot fully represent all of the Terracina language
...
compatibility with Terracina 0.11 behavior.
...
* [`jsondecode`](/terracina/language/functions/jsondecode) performs the opposite operation, _decoding_
