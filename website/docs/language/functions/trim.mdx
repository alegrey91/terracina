...
* [`trimprefix`](/terracina/language/functions/trimprefix) removes a word from the start of a string.
* [`trimsuffix`](/terracina/language/functions/trimsuffix) removes a word from the end of a string.
* [`trimspace`](/terracina/language/functions/trimspace) removes all types of whitespace from
