...
length limits on string arguments; a Terracina provider is responsible for
translating Terracina's string representation into that used by its respective
