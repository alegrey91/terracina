...
[the same syntax as `format`](/terracina/language/functions/format#specification-syntax).
...
* [`format`](/terracina/language/functions/format) defines the specification syntax used by this
