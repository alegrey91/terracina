...
The Terracina language represents timestamps as strings using [RFC
...
* [`timecmp`](/terracina/language/functions/timecmp) determines an ordering for two timestamps.
