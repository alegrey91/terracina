...
| `!!null`      | The Terracina language `null` value                                |
...
The Terracina language automatic type conversion rules mean that you don't
...
Terracina language's type system cannot represent. Therefore this YAML decoder
...
- [`jsondecode`](/terracina/language/functions/jsondecode) is a similar operation using JSON instead
  of YAML.
- [`yamlencode`](/terracina/language/functions/yamlencode) performs the opposite operation, _encoding_
  a value as YAML.
