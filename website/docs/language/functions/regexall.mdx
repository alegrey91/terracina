...
`regexall` is a variant of [`regex`](/terracina/language/functions/regex) and uses the same pattern
...
- [`regex`](/terracina/language/functions/regex) searches for a single match of a given pattern, and
