...
for transient values, such as the argument to [`file`](/terracina/language/functions/file) (where
...
* [`basename`](/terracina/language/functions/basename) returns _only_ the last portion of a filesystem
