...
The `filesha256` is a variant of [`sha256`](/terracina/language/functions/sha256)
...
- [`sha256`](/terracina/language/functions/sha256) computes the SHA-1 hash of a given string and encodes it with hexadecimal digits.
...
- [`filesha1`](/terracina/language/functions/filesha1)computes the SHA-1 hash of a given file and encodes it with hexadecimal digits.
