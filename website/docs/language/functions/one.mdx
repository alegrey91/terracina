...
-> **Note:** This function is available only in Terracina v0.15 and later.
...
The Terracina language has a built-in operator `[*]`, known as
[the _splat_ operator](/terracina/language/expressions/splat), and one of its functions
