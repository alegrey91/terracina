...
Unlike the related function [`cidrsubnets`](/terracina/language/functions/cidrsubnets), `cidrsubnet`
...
While [`cidrhost`](/terracina/language/functions/cidrhost) allows calculating single host IP addresses,
...
[`cidrhost`](/terracina/language/functions/cidrhost) function to calculate those host addresses by
...
* [`cidrhost`](/terracina/language/functions/cidrhost) calculates the IP address for a single host
  within a given network address prefix.
* [`cidrnetmask`](/terracina/language/functions/cidrnetmask) converts an IPv4 network prefix in CIDR
  notation into netmask notation.
* [`cidrsubnets`](/terracina/language/functions/cidrsubnets) can allocate multiple consecutive
