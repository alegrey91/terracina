...
related function [`cidrsubnet`](/terracina/language/functions/cidrsubnet). `cidrsubnet` calculates
...
-> **Note:** [The Terracina module `hashicorp/subnets/cidr`](https://registry.terracina.io/modules/hashicorp/subnets/cidr)
...
* [`cidrsubnet`](/terracina/language/functions/cidrsubnet) calculates a single subnet address, allowing
