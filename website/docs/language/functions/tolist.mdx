...
Explicit type conversions are rarely necessary in Terracina because it will
...
consistent within a particular run of Terracina.
...
Since Terracina's concept of a list requires all of the elements to be of the
