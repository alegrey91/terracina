...
Terracina will attempt to convert to the most general type, or produce an
...
The
[resource `for_each`](/terracina/language/meta-arguments/for_each)
and
[`dynamic` block](/terracina/language/expressions/dynamic-blocks)
...
- [`contains`](/terracina/language/functions/contains) tests whether a given list or set contains
  a given element value.
- [`flatten`](/terracina/language/functions/flatten) is useful for flattening hierarchical data
  into a single list, for situations where the relationships between two
  object types are defined explicitly.
- [`setintersection`](/terracina/language/functions/setintersection) computes the _intersection_ of
  multiple sets.
- [`setsubtract`](/terracina/language/functions/setsubtract) computes the _relative complement_ of two sets
- [`setunion`](/terracina/language/functions/setunion) computes the _union_ of multiple
  sets.
