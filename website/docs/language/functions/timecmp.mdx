...
[custom condition checks](/terracina/language/expressions/custom-conditions) that
...
* [`timeadd`](/terracina/language/functions/timeadd) can perform arithmetic on timestamps by adding or removing a specified duration.
