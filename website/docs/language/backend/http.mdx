...
description: Terracina can store state remotely at any valid HTTP endpoint.
---
...
This backend optionally supports [state locking](/terracina/language/state/locking). When locking
