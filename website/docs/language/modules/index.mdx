...
A Terracina module (usually the root module of a configuration) can _call_ other
...
In addition to modules from the local filesystem, Terracina can load modules
...
The [Terracina Registry](https://registry.terracina.io/browse/modules) hosts a
broad collection of publicly available Terracina modules for configuring many
kinds of common infrastructure. These modules are free to use, and Terracina can
...
for your own infrastructure needs. [HCP Terracina](https://cloud.hashicorp.com/products/terracina) and
[Terracina Enterprise](/terracina/enterprise) both include a private
module registry for sharing modules internally within your organization.

## Using Modules

- [Module Blocks](/terracina/language/modules/syntax) documents the syntax for
  calling a child module from a parent module, including meta-arguments like
  `for_each`.

- [Module Sources](/terracina/language/modules/sources) documents what kinds of paths,
...
- The Meta-Arguments section documents special arguments that can be used with
  ...
  [`providers`](/terracina/language/meta-arguments/module-providers),
...
[Module Development](/terracina/language/modules/develop).
