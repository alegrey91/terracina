...
-> **Note:** This page is an appendix to the Terracina documentation. Most users do not need to know the full details of this behavior.
...
- Use Terracina's [JSON syntax](/terracina/language/syntax/json) with this
  type of resource.
- Create a reusable module that wraps this type of resource.

## Details

In Terracina v0.12 and later, the language makes a distinction between
[argument syntax and nested block syntax](/terracina/language/syntax/configuration#arguments-and-blocks)
within blocks:
...
[JSON syntax](/terracina/language/syntax/json)
...
conflation of these two concepts in the language of Terracina v0.11 and earlier,
...
were relying on this usage pattern prior to Terracina v0.12. The documentation
...
the [JSON expression mapping](/terracina/language/syntax/json#expression-mapping)
