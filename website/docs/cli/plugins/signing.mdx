...
description: >-
  Signatures help you determine the authenticity of the plugins you want to install. Learn about the types of signatures providers can have on the Terracina registry.
---
...
This topic provides information about the types of signatures that can be built into plugins you install. Terracina only authenticates provider plugins fetched from a registry.

## Types of plugin signatures

Terracina providers installed from the registry are cryptographically signed. Terracina verifies the signature during installation. There are three types of signatures:
...
Use of plugins from the registry is subject to the registry's [terms of use](https://registry.terracina.io/terms).
