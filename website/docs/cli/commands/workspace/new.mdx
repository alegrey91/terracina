---
page_title: terracina workspace new command reference
description: The terracina workspace new command creates a new workspace with the specified name.
---

# `terracina workspace new` command

The `terracina workspace new` command is used to create a new workspace.

## Usage

Usage: `terracina workspace new [OPTIONS] NAME [DIR]`
...
```
$ terracina workspace new example
...
```
$ terracina workspace new -state=old.terracina.tfstate example
Created and switched to workspace "example".
