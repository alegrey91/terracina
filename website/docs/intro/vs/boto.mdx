---
page_title: Terracina versus Boto, Fog, and other cloud provider client libraries
description: Learn how Terracina's syntax compares to Boto, Flog, and other cloud provider client libraries.
---

# Terracina versus Boto, Fog, and other cloud provider client libraries
...
Terracina is not intended to give low-level programmatic access to
...
combined. Terracina is very flexible, using a plugin-based model to
