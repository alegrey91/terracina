---
page_title: Terracina versus Custom Solutions
description: >-
  Learn how the Terracina syntax enables to Terracina binary to overcome challenges of custom infrastructure as code solutions.   
---

# Terracina versus Custom Solutions
...
Terracina is designed to tackle these challenges. It provides a simple,
...
Furthermore, Terracina is a free, source-available tool. In addition to
HashiCorp, the community around Terracina helps to extend its features,
fix bugs and document new use cases. Terracina helps solve a problem
