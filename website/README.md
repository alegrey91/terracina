# Terracina Documentation

This directory contains the portions of [the Terracina website](https://www.terracina.io/) that pertain to the core functionality, excluding providers and the overall configuration.

The website uses the files in this directory in conjunction with
[the `terracina-website` repository](https://github.com/hashicorp/terracina-website). The `terracina-website` repository brings all of the documentation together and contains the scripts for testing and building the entire site.

## Suggesting Changes

You can [submit an issue](https://github.com/hashicorp/terracina/issues/new/choose) with documentation requests or submit a pull request with suggested changes.

Click **Edit this page** at the bottom of any Terracina website page to go directly to the associated markdown file in GitHub.
...
- Terracina Language: [`language-nav-data.json`](https://github.com/hashicorp/terracina/blob/main/website/data/language-nav-data.json)
- Terracina CLI: [`cli-nav-data.json`](https://github.com/hashicorp/terracina/blob/main/website/data/cli-nav-data.json)
- Introduction to Terracina: [`intro-nav-data.json`](https://github.com/hashicorp/terracina/blob/update-readme/website/data/intro-nav-data.json)

For more details about how to update the sidebar navigation, refer to [Editing Navigation Sidebars](https://github.com/hashicorp/terracina-website#editing-navigation-sidebars) in the `terracina-website` repository.

## Adding Redirects

You must add a redirect when you move, rename, or delete documentation pages. Refer to https://github.com/hashicorp/terracina-docs-common#redirects for details.

## Previewing Changes

You should preview all of your changes locally before creating a pull request. The build includes content from this repository and the [`terracina-website`](https://github.com/hashicorp/terracina-website/) repository, allowing you to preview the entire Terracina documentation site.
...
1. Navigate into your local `terracina` top-level directory and run `make website`.
